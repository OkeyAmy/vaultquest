...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "VaultQuest currently supports Solana, with plans to expand to Ethereum, Polygon, and other major networks in the near future. Our multi-chain strategy aims to provide users with options that best suit their needs.",
    },
    {
