...
export default function WinnersPage() {
  ...
  const winners = [
    { network: "Starknet", address: "0x8e49...7028", date: "January 18", price: "0.0009 WETH" },
    { network: "USDC", address: "0x8e49...7028", date: "January 18", price: "0.0009 WETH" },
    { network: "USDT", address: "0x8e49...7028", date: "January 18", price: "0.0009 WETH" },
    { network: "USDC", address: "0x8e49...7028", date: "January 18", price: "0.0009 WETH" },
    { network: "Starknet", address: "0x8e49...7028", date: "January 18", price: "0.0009 WETH" },
    { network: "USDT", address: "0x8e49...7028", date: "January 18", price: "0.0009 WETH" },
    { network: "Starknet", address: "0x8e49...7028", date: "January 18", price: "0.0009 WETH" },
  ...
  const filteredWinners =
    activeFilter === "all" ? winners : winners.filter((w) => w.network.toLowerCase() === activeFilter.toLowerCase())
            ...
            <div className="flex items-center gap-2 bg-[#2A0A0A]/80 backdrop-blur-sm rounded-full p-1 border border-red-900/10">
              ...
              <button
                className={`px-4 py-2 rounded-full text-sm transition-colors flex items-center gap-2 ${
                  activeFilter === "ethereum" ? "bg-red-600" : "hover:bg-[#3A0A0A]"
                }`}
              ...
              <button
                className={`px-4 py-2 rounded-full text-sm transition-colors flex items-center gap-2 ${
                  activeFilter === "starknet" ? "bg-red-600" : "hover:bg-[#3A0A0A]"
                }`}
